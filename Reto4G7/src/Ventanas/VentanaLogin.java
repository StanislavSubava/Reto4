...
import TodoMenuAdmin.VentanaMenuAdmin;
...
public class VentanaLogin extends JFrame {
	...
	/**
	 * Descripción: Abre la ventana principal de la aplicación para solicitar al usuario que introduzca sus credenciales y asi poderlo tener localizado en la aplicación.
	 * @author in1dm3
	 */
	public VentanaLogin() {
	        super("Ventana Login");
